...
/// Test utilities for mathematical operations and comparisons
...
pub const expectVec3Equal = TestUtils.expectVec3EqualDefault;
pub const expectVec3Close = TestUtils.expectVec3CloseDefault;
pub const expectVec3Orthogonal = TestUtils.expectVec3OrthogonalDefault;
pub const expectLength = TestUtils.expectLengthDefault;
pub const expectDotProduct = TestUtils.expectDotProductDefault;
pub const expectCrossProduct = TestUtils.expectCrossProductDefault;
pub const expectMat4Equal = TestUtils.expectMat4EqualDefault;
pub const expectMat4Close = TestUtils.expectMat4CloseDefault;
pub const expectMat4Identity = TestUtils.expectMat4IdentityDefault;
pub const expectMat4MulVec3 = TestUtils.expectMat4MulVec3Default;
pub const expectMat4Mul = TestUtils.expectMat4MulDefault;
pub const expectColorEqual = TestUtils.expectColorEqualDefault;
pub const expectColorOrthogonal = TestUtils.expectColorOrthogonalDefault;
pub const expectNormalized = TestUtils.expectNormalizedDefault;
pub const expectRightHandedSystem = TestUtils.expectRightHandedSystemDefault;
pub const expectAllOrthogonal = TestUtils.expectAllOrthogonalDefault;
pub const expectBoundingBox = TestUtils.expectBoundingBoxDefault;
pub const expectVertexData = TestUtils.expectVertexDataDefault;
pub const expectAxesVertexData = TestUtils.expectAxesVertexDataDefault;
pub const expectLineGeometry = TestUtils.expectLineGeometryDefault;
